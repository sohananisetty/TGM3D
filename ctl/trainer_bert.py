...
class BERTTrainer:
    ...
    def __init__(
        ...
        train_dataset = BERTMotionDataset(
            "t2m",
            "/srv/hays-lab/scratch/sanisetty3/music_motion/HumanMotionSMPLIndices/",
            split="train",
        )
        test_dataset = BERTMotionDataset(
            "t2m",
            "/srv/hays-lab/scratch/sanisetty3/music_motion/HumanMotionSMPLIndices/",
            split="test",
        )

        self.train_data = DataLoader(train_dataset, batch_size=256, num_workers=0)

        self.test_data = DataLoader(test_dataset, batch_size=256, num_workers=0)
    ...
    def save(
        self,
        epoch,
        file_path="/srv/hays-lab/scratch/sanisetty3/music_motion/TGM3D/checkpoints/bert/",
    ):
        """
        ...
        """
        output_path = file_path + f"bert_trained_{epoch}.pt"
