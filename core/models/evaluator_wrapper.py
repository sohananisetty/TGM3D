...
class AISTEvaluatorModelWrapper(object):
    def __init__(self, cfg):
        self.motion_extractor = AISTEncoderBiGRUCo(
            cfg.extractor.motion_input_size,
            cfg.extractor.hidden_size,
            cfg.extractor.output_size,
        )
        self.music_extractor = AISTEncoderBiGRUCo(
            cfg.extractor.music_input_size,
            cfg.extractor.hidden_size,
            cfg.extractor.output_size,
        )
        self.opt = cfg
