...
class Text2MotionDataset(data.Dataset):
    def __init__(
        ...
        min_motion_len = 64 if self.dataset_name == "t2m" else 24
        # min_motion_len = 64
...
class Text2MotionDataset2(data.Dataset):
    def __init__(
        self,
        w_vectorizer,
        dataset_name="t2m",
...
def DATALoader(batch_size, w_vectorizer, num_workers=0, unit_length=4, is_test=True):
    val_loader = torch.utils.data.DataLoader(
        Text2MotionDataset(w_vectorizer, is_test=is_test, unit_length=unit_length),
        batch_size,
        shuffle=False,
